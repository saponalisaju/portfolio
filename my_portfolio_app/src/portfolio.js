...
const greeting = {
  ...
  subTitle: emoji(
    "🚀 Full Stack Web & Android App Developer specializing in the MERN stack. Skilled in building scalable applications using Python/Django, React.js, Node.js, React Native, Java, and other modern technologies."
  ),
